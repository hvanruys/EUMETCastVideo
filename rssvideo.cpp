...
RSSVideo::RSSVideo( QString xmlfile, QObject *parent ) : QObject(parent)
{
    reader = new XMLVideoReader(xmlfile);
...
void RSSVideo::ComposeVISIR(quint16 *ptrDayRed, quint16 *ptrDayGreen, quint16 *ptrDayBlue, quint16 *ptrNightRed, quint16 *ptrNightGreen, quint16 *ptrNightBlue, QImage &imvisir, QString date, int imagenbr)
{
    ...
    QImage imageday(3712, reader->brss ? 1392 : 3712, QImage::Format_ARGB32);
    imageday.fill(Qt::black);
    QImage imagenight(3712, reader->brss ? 1392 : 3712, QImage::Format_ARGB32);
